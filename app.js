...
entus: {
  name: "Энтус",
  color: "linear-gradient(135deg, #ff4da6, #6a1b9a)",
  phrases: [
    "эээ… а?",
    "сейчас подожди… нет, уже поздно",
    "это было важно. наверное.",
    "я не понял, но ты держись",
    "ты уверен что это я сказал?",
    "мне кажется или всё сломалось",
    "это знак. или не знак.",
    "ну да. логично. почти.",
    "я бы объяснил, но не хочу",
    "ты ожидал другого, да?",
    "ха. смешно. мне.",
    "так не делай. или делай. я запутался",
    "это звучит умно если не думать",
    "я предупреждал. когда-то.",
    "ты всё понял. но не так.",
    "ладно, забудь",
    "ой",
    "неловко вышло",
    "я вообще тут случайно",
    "энергия есть, смысла нет"
  ]
},
  watafa: {
    name: "Ватафа",
